    ...
    <div>
      ...
      <section id="heroSection" className="hero--section">
        <div className="hero--section--img">
          <img src="./img/Project1.png" alt="Hero Section" />
        </div>
        <div className="hero--section--content--box">
          <div className="hero--section--content">

            <h1 className="hero--section--title">
              <span className="hero--section-title--color">Projects</span>

            </h1>


            <p className="hero--section-description">
              As a Front-end Engineer, I specialize in creating responsive and dynamic web applications that provide seamless user experiences. My projects leverage a diverse array of the latest technology tools and frameworks, allowing me to implement modern design principles and enhance performance. I am proficient in HTML, CSS, and JavaScript, along with libraries and frameworks such as React .
      ...
      <section className="portfolio--section" id="MyPortfolio">
        <div className="portfolio--container-box">
          ...
          <div>
            {/* <button className="btn btn-github bg-sky-500 text-white">
            <svg
          ...
          {data?.portfolio?.map((item, index) => (
            <div key={index} className="portfolio--section--card">
              ...
              <div className="portfolio--section--card--content">
                <div>
                  <h3 className="portfolio--section--title"><b>{item.title}</b></h3>
